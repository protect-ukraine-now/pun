import rusLocale from 'date-fns/locale/ru';
...
const AmmoTable = ({ data, date }) => ((
    <Container className={style.container}>
      <h1 className={style.heading}>ТЯЖЕЛОЕ ВООРУЖЕНИЕ ПО СОСТОЯНИЮ НА {format(new Date(date), 'd MMMM yyyy ГОДА', { locale: rusLocale }).toUpperCase()}</h1>
